...
public final class CommandBuilder {
    ...
    // Discord permissions
    private EnumSet<Permissions> permissionLevel = LevelDefaults.DEFAULT_PERMS_RW;
    ...
    public CommandPackage build(CommandExecutable executable) {
        ...
        return new CommandPackage(
                new CommandD4J(this.id, this.isRegistryAware) {
                    @Override
                ...
                new PermissionPropertiesD4J(new PermissionData(this.allowDm, this.forceDm, this.forceDmReply, this.removeCallMsg, this.rateLimitPeriodMs,
