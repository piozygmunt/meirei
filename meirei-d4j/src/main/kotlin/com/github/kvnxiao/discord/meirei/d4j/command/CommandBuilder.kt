...
/**
 * Builder class to help create a (D4J) command package for adding to the command registry
 */
...
(private val id: String) {
    ...
    // Discord permissions
    private val permissionLevel = LevelDefaults.DEFAULT_PERMS_RW
     ...
     * @return the current command builder
     */
    fun permissionLevel(vararg permissions: Permissions): CommandBuilder {
    ...
    /**
     * Builds the D4J command package using the values set in the builder.
     * @param executable the command method
     * @return the (D4J) command package containing the executable, command properties, and permission properties
     */
    fun build(executable: CommandExecutable): CommandPackage {
        ...
        return CommandPackage(
            object : CommandD4J(this.id, this.isRegistryAware) {
            ...
            PermissionPropertiesD4J(PermissionData(this.allowDm, this.forceDm, this.forceDmReply, this.removeCallMsg, this.rateLimitPeriodMs,
